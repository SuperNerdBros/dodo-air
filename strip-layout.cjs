...
if (wrappersStart !== -1 && wrappersEnd !== -1) {
  content = content.substring(0, wrappersStart) + 
...
content = content.replace(/bind:selectedFlightId/g, 'bind:selectedFlightId={dalStore.selectedFlightId}');
...
content = content.replace(/handleHostFlight=\{handleHostFlight\}/g, 'handleHostFlight={TerminalActions.hostFlight}');
content = content.replace(/handleUpdateStatus=\{handleUpdateStatus\}/g, 'handleUpdateStatus={TerminalActions.updateStatus}');
content = content.replace(/handleLeaveFlight=\{handleLeaveFlight\}/g, 'handleLeaveFlight={TerminalActions.leaveFlight}');
content = content.replace(/handleGenerateAIReview=\{handleGenerateAIReview\}/g, 'handleGenerateAIReview={TerminalActions.generateAIReview}');
content = content.replace(/handleClearForTakeoff=\{handleClearForTakeoff\}/g, 'handleClearForTakeoff={TerminalActions.clearForTakeoff}');
