          ...
          <div class="flex-1 space-y-4 flex flex-col">
            ...
            <div class="grid grid-cols-2 gap-4">
              <div class="space-y-1">
                ...
                <span class="font-system font-black tracking-wide text-slate-600 text-sm block bg-slate-50 p-1.5 rounded-lg text-center border border-slate-200 truncate">{isGuest ? 'Not registered' : passport.friendCode}</span>
              </div>
              
              <div class="space-y-1">
                <span class="block text-[10px] font-system font-bold text-[#85806B] uppercase">DREAM ADDRESS</span>
                <span class="font-system font-black tracking-wide text-purple-600 text-sm block bg-purple-50 p-1.5 rounded-lg text-center border border-purple-200 truncate">{isGuest ? 'Not registered' : (passport.dreamAddress || 'Not set')}</span>
              </div>
    
              <div class="space-y-1 col-span-2 sm:col-span-1">
                <span class="block text-[10px] font-system font-bold text-[#85806B] uppercase">FLIGHT NUMBER</span>
                <div class="flex items-center gap-2">
                  <span class="font-system font-black tracking-wide text-[#0084CC] text-sm block bg-sky-50 p-1.5 rounded-lg text-center border border-sky-200 flex-1 truncate">{isGuest ? 'Not registered' : (passport.flightNumber || 'Not set')}</span>
