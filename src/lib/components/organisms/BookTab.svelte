              ...
              <Box class="flex items-center gap-3">
                ...
                <Box>
                  <Box class="flex items-center flex-wrap gap-1">
                    <Text tag="span" class="font-system text-xs font-black text-[#0084CC] tracking-wider">{flight.flightNumber ? (dalStore.systemMode === 'DAL' ? 'DAL-' : 'LUL-') + flight.flightNumber.replace(/^(DAL-|LUL-|LUNA-)/i, '') : flight.id}</Text>
